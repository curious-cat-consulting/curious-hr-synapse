...
select enum_has_labels('synapse', 'notification_type', 
    ARRAY['EXPENSE_CREATED', 'EXPENSE_ANALYZED', 'EXPENSE_APPROVED', 'EXPENSE_REJECTED', 'RECEIPT_PROCESSED', 'TEAM_INVITATION', 'TEAM_MEMBER_ADDED', 'POSTING_TEAM_UPDATED', 'GENERAL'],
